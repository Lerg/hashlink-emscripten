...
bool hxsl_Tools_hasSideEffect(vvirtual* r0) {
	...
	switch(r3) {
		...
		case 10:
			...
			r6 = hxsl_Tools_hasSideEffect(r10);
			if( r6 ) goto label$125a773_9_115;
			if( !r18 ) goto label$125a773_9_113;
		...
		case 13:
			...
			r6 = hxsl_Tools_hasSideEffect(r2);
			if( r6 ) goto label$125a773_9_129;
			r6 = hxsl_Tools_hasSideEffect(r10);
			return r6;
			label$125a773_9_129:
			r6 = true;
		...
		case 18:
			...
			if( !r10 ) goto label$125a773_9_208;
			r6 = hxsl_Tools_hasSideEffect(r10);
			return r6;
			label$125a773_9_208:
			r6 = false;
...
void hxsl_Tools_iter(vvirtual* r0,vclosure* r1) {
	...
	switch(r5) {
		...
		case 10:
			...
			r1->hasValue ? ((void (*)(vdynamic*,vvirtual*))r1->fun)((vdynamic*)r1->value,r3) : ((void (*)(vvirtual*))r1->fun)(r3);
			r1->hasValue ? ((void (*)(vdynamic*,vvirtual*))r1->fun)((vdynamic*)r1->value,r9) : ((void (*)(vvirtual*))r1->fun)(r9);
			if( !r17 ) goto label$125a773_10_86;
		...
		case 12:
			...
			if( !r3 ) goto label$125a773_10_92;
			if( r1 == NULL ) hl_null_access();
			r1->hasValue ? ((void (*)(vdynamic*,vvirtual*))r1->fun)((vdynamic*)r1->value,r3) : ((void (*)(vvirtual*))r1->fun)(r3);
			label$125a773_10_92:
			goto label$125a773_10_181;
		...
		case 18:
			...
			if( !r9 ) goto label$125a773_10_168;
			if( r1 == NULL ) hl_null_access();
			r1->hasValue ? ((void (*)(vdynamic*,vvirtual*))r1->fun)((vdynamic*)r1->value,r9) : ((void (*)(vvirtual*))r1->fun)(r9);
...
vvirtual* hxsl_Tools_map(vvirtual* r0,vclosure* r1) {
	...
	switch(r4) {
		...
		case 10:
			...
			if( !r20 ) goto label$125a773_11_122;
		...
		case 12:
			r3 = ((hxsl_TExprDef_TReturn*)r2)->p0;
			if( !r3 ) goto label$125a773_11_134;
			if( r1 == NULL ) hl_null_access();
			r10 = r1->hasValue ? ((vvirtual* (*)(vdynamic*,vvirtual*))r1->fun)((vdynamic*)r1->value,r3) : ((vvirtual* (*)(vvirtual*))r1->fun)(r3);
			goto label$125a773_11_135;
			label$125a773_11_134:
			r10 = NULL;
			label$125a773_11_135:
		...
		case 18:
			...
			if( r10 ) goto label$125a773_11_240;
			r23 = NULL;
