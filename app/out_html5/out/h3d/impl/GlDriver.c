...
void h3d_impl_GlDriver_uploadTexturePixels(h3d__impl__GlDriver r0,h3d__mat__Texture r1,hxd__Pixels r2,int r3,int r4) {
	...
	if( r18 ) goto label$8f388d3_33_50;
	r12 = NULL;
	goto label$8f388d3_33_51;
	label$8f388d3_33_50:
	r12 = r18->bytes;
	label$8f388d3_33_51:
	r19 = r2->offset;
	...
	r22 = r21 - r23;
	r24 = r0->streamLen;
	if( r24 >= r21 ) goto label$8f388d3_33_63;
	...
	r24 = 21;
	if( r23 != r24 ) goto label$8f388d3_33_80;
	r23 = ((hxd_PixelFormat_S3TC*)r16)->p0;
	r27 = true;
	goto label$8f388d3_33_81;
	label$8f388d3_33_80:
	r27 = false;
	label$8f388d3_33_81:
	if( !r27 ) goto label$8f388d3_33_98;
	r23 = r1->flags;
	r24 = 2048;
	r23 = r23 & r24;
	r24 = 0;
	if( r23 == r24 ) goto label$8f388d3_33_90;
	r29 = (String)s$e7f4c17;
	...
	goto label$8f388d3_33_118;
	label$8f388d3_33_98:
	r23 = r1->flags;
	r24 = 2048;
	r23 = r23 & r24;
	r24 = 0;
	if( r23 == r24 ) goto label$8f388d3_33_106;
	r29 = (String)s$e7f4c17;
	r28 = haxe_Exception_thrown(((vdynamic*)r29));
	hl_throw((vdynamic*)r28);
	label$8f388d3_33_106:
	r15 = r1->_t;
	if( r15 == NULL ) hl_null_access();
	r26 = hl_vfields(r15)[4] ? (*(int*)(hl_vfields(r15)[4])) : (int)hl_dyn_geti(r15->value,46889754/*internalFmt*/,&t$_i32);
	r30 = r2->width;
...
void h3d_impl_GlDriver_new(h3d__impl__GlDriver r0,int* r1) {
	...
	if( !r7 ) goto label$8f388d3_49_157;
	r6 = 1;
	...
	r23->v.d = r22;
	r0->glES = r23;
	label$8f388d3_49_157:
	r23 = r0->glES;
	if( r23 ) goto label$8f388d3_49_163;
	r11 = sdl_gl_create_vertex_array();
	r0->commonVA = r11;
	r11 = r0->commonVA;
	sdl_gl_bind_vertex_array(r11);
	label$8f388d3_49_163:
	...
	if( !r7 ) goto label$8f388d3_49_180;
	r6 = 0;
