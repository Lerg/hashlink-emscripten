...
void h3d_Buffer_uploadVector(h3d__Buffer r0,hl__types__ArrayBytes_hl_F32 r1,int r2,int r3,int* r4) {
	...
	r6 = r0;
	label$e040f64_3_5:
	if( !r6 ) goto label$e040f64_3_16;
	if( r6 == NULL ) hl_null_access();
	r10 = r6->vertices;
	if( r5 < r10 ) goto label$e040f64_3_16;
	r10 = r6->vertices;
	r9 = r5 - r10;
	r5 = r9;
	r8 = r6->next;
	r6 = r8;
	goto label$e040f64_3_5;
	label$e040f64_3_16:
	r10 = 0;
	if( r10 >= r3 ) goto label$e040f64_3_51;
	if( r6 ) goto label$e040f64_3_23;
	...
	if( r6 == NULL ) hl_null_access();
	r10 = r6->vertices;
	if( r10 >= r9 ) goto label$e040f64_3_30;
	r9 = r6->vertices;
	r9 = r9 - r5;
	goto label$e040f64_3_31;
	label$e040f64_3_30:
	r9 = r3;
	label$e040f64_3_31:
	r13 = r6->buffer;
