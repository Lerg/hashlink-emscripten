...
vvirtual* Xml_elements(Xml r0) {
	...
	r12 = r11->length;
	if( r2 >= r12 ) goto label$2aaea8e_13_40;
	r12 = r11->length;
	if( ((unsigned)r2) < ((unsigned)r12) ) goto label$2aaea8e_13_28;
	r13 = NULL;
	goto label$2aaea8e_13_31;
	label$2aaea8e_13_28:
	r9 = r11->array;
	r5 = ((vdynamic**)(r9 + 1))[r2];
	r13 = (Xml)r5;
	...
	r4 = ($Xml)g$_Xml;
	r12 = r4->Element;
	if( r3 != r12 ) goto label$2aaea8e_13_39;
	if( r8 == NULL ) hl_null_access();
	r3 = hl_types_ArrayObj_push(r8,((vdynamic*)r13));
	label$2aaea8e_13_39:
	goto label$2aaea8e_13_20;
	label$2aaea8e_13_40:
...
vvirtual* Xml_elementsNamed(Xml r0,String r1) {
	...
	r5 = ($Xml)g$_Xml;
	r4 = r5->Document;
	if( r3 == r4 ) goto label$2aaea8e_14_14;
	r3 = r0->nodeType;
	r5 = ($Xml)g$_Xml;
	r4 = r5->Element;
	if( r3 == r4 ) goto label$2aaea8e_14_14;
	...
	r13 = r12->length;
	if( r3 >= r13 ) goto label$2aaea8e_14_58;
	r13 = r12->length;
	if( ((unsigned)r3) < ((unsigned)r13) ) goto label$2aaea8e_14_28;
	r14 = NULL;
	...
	r5 = ($Xml)g$_Xml;
	r13 = r5->Element;
	if( r4 != r13 ) goto label$2aaea8e_14_53;
	r4 = r14->nodeType;
	r5 = ($Xml)g$_Xml;
	r13 = r5->Element;
	if( r4 == r13 ) goto label$2aaea8e_14_47;
	r7 = (String)s$63ec124;
	r4 = r14->nodeType;
	...
	label$2aaea8e_14_47:
	r7 = r14->nodeName;
	if( r7 == r1 || (r7 && r1 && String___compare(r7,(vdynamic*)r1) == 0) ) goto label$2aaea8e_14_51;
	r15 = false;
	goto label$2aaea8e_14_52;
	label$2aaea8e_14_51:
	r15 = true;
	label$2aaea8e_14_52:
	goto label$2aaea8e_14_54;
	label$2aaea8e_14_53:
	r15 = false;
	label$2aaea8e_14_54:
	if( !r15 ) goto label$2aaea8e_14_57;
	if( r9 == NULL ) hl_null_access();
...
Xml Xml_firstElement(Xml r0) {
	...
	r3 = ($Xml)g$_Xml;
	r2 = r3->Document;
	if( r1 == r2 ) goto label$2aaea8e_15_14;
	r1 = r0->nodeType;
	r3 = ($Xml)g$_Xml;
	r2 = r3->Element;
	if( r1 == r2 ) goto label$2aaea8e_15_14;
	...
	r8 = r7->length;
	if( r1 >= r8 ) goto label$2aaea8e_15_35;
	r8 = r7->length;
	if( ((unsigned)r1) < ((unsigned)r8) ) goto label$2aaea8e_15_24;
	r9 = NULL;
	goto label$2aaea8e_15_27;
	label$2aaea8e_15_24:
	r10 = r7->array;
	...
	r3 = ($Xml)g$_Xml;
	r8 = r3->Element;
	if( r2 != r8 ) goto label$2aaea8e_15_34;
	return r9;
	label$2aaea8e_15_34:
	goto label$2aaea8e_15_16;
	label$2aaea8e_15_35:
	r9 = NULL;
	return r9;
}
...
void Xml_addChild(Xml r0,Xml r1) {
	...
	r5 = ($Xml)g$_Xml;
	r4 = r5->Document;
	if( r3 == r4 ) goto label$2aaea8e_16_14;
	r3 = r0->nodeType;
	r5 = ($Xml)g$_Xml;
	r4 = r5->Element;
	if( r3 == r4 ) goto label$2aaea8e_16_14;
	...
	r9 = r1->parent;
	if( !r9 ) goto label$2aaea8e_16_20;
	r9 = r1->parent;
	if( r9 == NULL ) hl_null_access();
...
bool Xml_removeChild(Xml r0,Xml r1) {
	...
	r4 = ($Xml)g$_Xml;
	r3 = r4->Document;
	if( r2 == r3 ) goto label$2aaea8e_17_14;
	r2 = r0->nodeType;
	r4 = ($Xml)g$_Xml;
	r3 = r4->Element;
	if( r2 == r3 ) goto label$2aaea8e_17_14;
	...
	if( !r8 ) goto label$2aaea8e_17_23;
	if( r1 == NULL ) hl_null_access();
	r10 = NULL;
	r1->parent = r10;
	r8 = true;
