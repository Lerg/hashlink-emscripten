...
vdynamic* Type_createEnumIndex(hl__BaseType r0,int r1,hl__types__ArrayDyn r2) {
	...
	r5 = 0;
	if( r1 < r5 ) goto label$9fea9d9_10_8;
	if( r3 == NULL ) hl_null_access();
	r6 = r3->__constructs__;
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( r1 < r5 ) goto label$9fea9d9_10_21;
	label$9fea9d9_10_8:
	...
	label$9fea9d9_10_21:
	if( !r2 ) goto label$9fea9d9_10_26;
	if( r2 == NULL ) hl_null_access();
	r4 = hl_types_ArrayDyn_get_length(r2);
	r5 = 0;
	if( r4 != r5 ) goto label$9fea9d9_10_54;
	label$9fea9d9_10_26:
	r13 = r3->__evalues__;
	r5 = r13->size;
	if( r1 < r5 ) goto label$9fea9d9_10_31;
	r15 = NULL;
	goto label$9fea9d9_10_33;
	label$9fea9d9_10_31:
	r14 = r3->__evalues__;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	label$9fea9d9_10_33:
	if( r15 ) goto label$9fea9d9_10_53;
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$9fea9d9_10_45;
	r9 = NULL;
	goto label$9fea9d9_10_48;
	label$9fea9d9_10_45:
	r14 = r6->array;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	r9 = (String)r15;
	...
	if( r16 ) goto label$9fea9d9_10_80;
	r17 = r2->array;
	if( r17 == NULL ) hl_null_access();
	r4 = r17->length;
	r18 = &t$_dyn;
	...
	r19 = r17->length;
	label$9fea9d9_10_69:
	if( r5 >= r19 ) goto label$9fea9d9_10_79;
	r20 = r5;
	++r5;
	if( r12 == NULL ) hl_null_access();
	r17 = r12->array;
	...
	goto label$9fea9d9_10_69;
	label$9fea9d9_10_79:
	goto label$9fea9d9_10_85;
	label$9fea9d9_10_80:
	r17 = r2->array;
	...
	if( r7 ) goto label$9fea9d9_10_119;
	r8 = (String)s$Constructor_;
	r9 = r3->__ename__;
	r8 = String___add__(r8,r9);
	r9 = (String)s$5058f1a;
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$9fea9d9_10_104;
	r9 = NULL;
	goto label$9fea9d9_10_107;
	label$9fea9d9_10_104:
	r13 = r6->array;
	r15 = ((vdynamic**)(r13 + 1))[r1];
	r9 = (String)r15;
	label$9fea9d9_10_107:
	r8 = String___add__(r8,r9);
...
String Type_enumConstructor(vdynamic* r0) {
	...
	r6 = r4->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$9fea9d9_11_10;
	r7 = NULL;
	goto label$9fea9d9_11_13;
	label$9fea9d9_11_10:
	r8 = r4->array;
	r2 = ((vdynamic**)(r8 + 1))[r5];
	r7 = (String)r2;
...
hl__types__ArrayDyn Type_allEnums(hl__BaseType r0) {
	...
	r9 = r3->size;
	label$9fea9d9_14_12:
	if( r5 >= r9 ) goto label$9fea9d9_14_23;
	r11 = r5;
	++r5;
	if( r1 == NULL ) hl_null_access();
	r10 = r1->__evalues__;
	r13 = ((vdynamic**)(r10 + 1))[r11];
	if( !r13 ) goto label$9fea9d9_14_22;
	if( r2 == NULL ) hl_null_access();
	r12 = hl_types_ArrayDyn_push(r2,r13);
	label$9fea9d9_14_22:
	goto label$9fea9d9_14_12;
	label$9fea9d9_14_23:
	return r2;
}
