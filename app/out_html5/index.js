...
var ASM_CONSTS = {
 ...
 600084: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 600177: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 600246: function() {return screen.width;},  
 600271: function() {return screen.height;},  
 600297: function() {return window.innerWidth;},  
 600327: function() {return window.innerHeight;},  
 600358: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 600453: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 600590: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 600814: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 601307: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 ...
 604522: function($0) {var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; }}
  ...
  err('missing function: glTexImage3D'); abort(-1);
  }
  ...
  /** @type {function(...*):?} */
  function _openal_al_auxiliary_effect_slotf(
  ) {
  err('missing function: openal_al_auxiliary_effect_slotf'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_auxiliary_effect_slotfv(
  ) {
  err('missing function: openal_al_auxiliary_effect_slotfv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_auxiliary_effect_sloti(
  ) {
  err('missing function: openal_al_auxiliary_effect_sloti'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_auxiliary_effect_slotiv(
  ) {
  err('missing function: openal_al_auxiliary_effect_slotiv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_delete_auxiliary_effect_slots(
  ) {
  err('missing function: openal_al_delete_auxiliary_effect_slots'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_delete_effects(
  ) {
  err('missing function: openal_al_delete_effects'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_delete_filters(
  ) {
  err('missing function: openal_al_delete_filters'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_effectf(
  ) {
  err('missing function: openal_al_effectf'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_effectfv(
  ) {
  err('missing function: openal_al_effectfv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_effecti(
  ) {
  err('missing function: openal_al_effecti'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_effectiv(
  ) {
  err('missing function: openal_al_effectiv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_filterf(
  ) {
  err('missing function: openal_al_filterf'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_filterfv(
  ) {
  err('missing function: openal_al_filterfv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_filteri(
  ) {
  err('missing function: openal_al_filteri'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_filteriv(
  ) {
  err('missing function: openal_al_filteriv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_gen_auxiliary_effect_slots(
  ) {
  err('missing function: openal_al_gen_auxiliary_effect_slots'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_gen_effects(
  ) {
  err('missing function: openal_al_gen_effects'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_gen_filters(
  ) {
  err('missing function: openal_al_gen_filters'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_auxiliary_effect_slotf(
  ) {
  err('missing function: openal_al_get_auxiliary_effect_slotf'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_auxiliary_effect_slotfv(
  ) {
  err('missing function: openal_al_get_auxiliary_effect_slotfv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_auxiliary_effect_sloti(
  ) {
  err('missing function: openal_al_get_auxiliary_effect_sloti'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_auxiliary_effect_slotiv(
  ) {
  err('missing function: openal_al_get_auxiliary_effect_slotiv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_effectf(
  ) {
  err('missing function: openal_al_get_effectf'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_effectfv(
  ) {
  err('missing function: openal_al_get_effectfv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_effecti(
  ) {
  err('missing function: openal_al_get_effecti'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_effectiv(
  ) {
  err('missing function: openal_al_get_effectiv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_filterf(
  ) {
  err('missing function: openal_al_get_filterf'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_filterfv(
  ) {
  err('missing function: openal_al_get_filterfv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_filteri(
  ) {
  err('missing function: openal_al_get_filteri'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_get_filteriv(
  ) {
  err('missing function: openal_al_get_filteriv'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_is_auxiliary_effect_slot(
  ) {
  err('missing function: openal_al_is_auxiliary_effect_slot'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_is_effect(
  ) {
  err('missing function: openal_al_is_effect'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _openal_al_is_filter(
  ) {
  err('missing function: openal_al_is_filter'); abort(-1);
  }
...
var asmLibraryArg = {
  ...
  "mktime": _mktime,
  "openal_al_auxiliary_effect_slotf": _openal_al_auxiliary_effect_slotf,
  "openal_al_auxiliary_effect_slotfv": _openal_al_auxiliary_effect_slotfv,
  "openal_al_auxiliary_effect_sloti": _openal_al_auxiliary_effect_sloti,
  "openal_al_auxiliary_effect_slotiv": _openal_al_auxiliary_effect_slotiv,
  "openal_al_delete_auxiliary_effect_slots": _openal_al_delete_auxiliary_effect_slots,
  "openal_al_delete_effects": _openal_al_delete_effects,
  "openal_al_delete_filters": _openal_al_delete_filters,
  "openal_al_effectf": _openal_al_effectf,
  "openal_al_effectfv": _openal_al_effectfv,
  "openal_al_effecti": _openal_al_effecti,
  "openal_al_effectiv": _openal_al_effectiv,
  "openal_al_filterf": _openal_al_filterf,
  "openal_al_filterfv": _openal_al_filterfv,
  "openal_al_filteri": _openal_al_filteri,
  "openal_al_filteriv": _openal_al_filteriv,
  "openal_al_gen_auxiliary_effect_slots": _openal_al_gen_auxiliary_effect_slots,
  "openal_al_gen_effects": _openal_al_gen_effects,
  "openal_al_gen_filters": _openal_al_gen_filters,
  "openal_al_get_auxiliary_effect_slotf": _openal_al_get_auxiliary_effect_slotf,
  "openal_al_get_auxiliary_effect_slotfv": _openal_al_get_auxiliary_effect_slotfv,
  "openal_al_get_auxiliary_effect_sloti": _openal_al_get_auxiliary_effect_sloti,
  "openal_al_get_auxiliary_effect_slotiv": _openal_al_get_auxiliary_effect_slotiv,
  "openal_al_get_effectf": _openal_al_get_effectf,
  "openal_al_get_effectfv": _openal_al_get_effectfv,
  "openal_al_get_effecti": _openal_al_get_effecti,
  "openal_al_get_effectiv": _openal_al_get_effectiv,
  "openal_al_get_filterf": _openal_al_get_filterf,
  "openal_al_get_filterfv": _openal_al_get_filterfv,
  "openal_al_get_filteri": _openal_al_get_filteri,
  "openal_al_get_filteriv": _openal_al_get_filteriv,
  "openal_al_is_auxiliary_effect_slot": _openal_al_is_auxiliary_effect_slot,
  "openal_al_is_effect": _openal_al_is_effect,
  "openal_al_is_filter": _openal_al_is_filter,
