...
int haxe_io_Bytes_getInt32(haxe__io__Bytes r0,int r1) {
	...
	r2 = r1 + r3;
	r3 = r0->length;
	if( ((unsigned)r2) < ((unsigned)r3) ) goto label$f9d86ae_9_6;
	r2 = 0;
	return r2;
	label$f9d86ae_9_6:
	r4 = r0->b;
...
haxe___Int64_____Int64 haxe_io_Bytes_getInt64(haxe__io__Bytes r0,int r1) {
	...
	r3 = r1 + r4;
	r4 = r0->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$f9d86ae_10_9;
...
String haxe_io_Bytes_toHex(haxe__io__Bytes r0) {
	...
	r8 = r7->length;
	label$f9d86ae_15_10:
	if( r6 >= r8 ) goto label$f9d86ae_15_19;
	r10 = r6;
	++r6;
	...
	goto label$f9d86ae_15_10;
	label$f9d86ae_15_19:
	r6 = 0;
	r8 = r0->length;
	label$f9d86ae_15_21:
	if( r6 >= r8 ) goto label$f9d86ae_15_51;
	r10 = r6;
	++r6;
	...
	r13 = r11 >> r14;
	r14 = r3->length;
	if( ((unsigned)r13) < ((unsigned)r14) ) goto label$f9d86ae_15_34;
	r12 = NULL;
	goto label$f9d86ae_15_37;
	label$f9d86ae_15_34:
	r4 = r3->array;
	...
	r13 = r11 & r14;
	r14 = r3->length;
	if( ((unsigned)r13) < ((unsigned)r14) ) goto label$f9d86ae_15_45;
	r12 = NULL;
	goto label$f9d86ae_15_48;
	label$f9d86ae_15_45:
	r4 = r3->array;
	r15 = ((vdynamic**)(r4 + 1))[r13];
	r12 = (vdynamic*)r15;
