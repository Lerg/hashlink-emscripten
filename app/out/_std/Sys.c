...
int Sys_command(String r0,hl__types__ArrayObj r1) {
	...
	goto label$e42c1e8_5_83;
	label$e42c1e8_5_5:
	r6 = Sys_systemName();
	r7 = (String)s$Windows;
	if( r6 != r7 && (!r6 || !r7 || String___compare(r6,(vdynamic*)r7) != 0) ) goto label$e42c1e8_5_47;
	r9 = &t$String;
	r4 = 0;
	...
	if( r10 == NULL ) hl_null_access();
	r13 = r10->length;
	if( r4 >= r13 ) goto label$e42c1e8_5_41;
	r13 = r10->length;
	if( ((unsigned)r4) < ((unsigned)r13) ) goto label$e42c1e8_5_32;
	r6 = NULL;
	goto label$e42c1e8_5_35;
	label$e42c1e8_5_32:
	r8 = r10->array;
	...
	if( r10 == NULL ) hl_null_access();
	r13 = r10->length;
	if( r4 >= r13 ) goto label$e42c1e8_5_78;
	r13 = r10->length;
	if( ((unsigned)r4) < ((unsigned)r13) ) goto label$e42c1e8_5_69;
	r6 = NULL;
	goto label$e42c1e8_5_72;
	label$e42c1e8_5_69:
	r8 = r10->array;
	r14 = ((vdynamic**)(r8 + 1))[r4];
	r6 = (String)r14;
